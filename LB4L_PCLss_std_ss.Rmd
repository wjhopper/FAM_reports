---
title: "LB4L PCL Ss Standard Model"
author: "Will Hopper"
date: "`r Sys.Date()`"
output: 
  html_document:
...
for (i in unique(IVdata_all$subject)) {
  ...
  grid.arrange(IVplot, condPlot ,ncol=1,nrow=2)
...
grid.arrange(IVplot_grouped,condPlot_grouped,ncol=2,nrow=1)
